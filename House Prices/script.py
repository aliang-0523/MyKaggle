...
def get_score(prediction,labels):
    ...
    print('RMSE:{}'.format(np.sqrt(mean_squared_error(prediction,
                                                      labels))))
def train_test(estimator,x_trn,x_test,y_trn,y_tst):
...
numeric_features_standarlized=(numeric_features-numeric_features.mean())/numeric_features.std()

ax=sns.pairplot(numeric_features_standarlized)
...
features_standardized.update(numeric_features_standarlized)
